...
public class ResourceAssetProxyFactory : IAssetFactory
{
    ...
    private Dictionary<string, Object> m_Soldiers = null;
    private Dictionary<string, Object> m_Enemys = null;
    private Dictionary<string, Object> m_Weapons = null;
    private Dictionary<string, Object> m_Effects = null;
    ...
    public override GameObject LoadEnemy(string AssetName)
    {
        ...
        {
            Object res = m_RealFactory.LoadGameObjectFromResourcePath(ResourceAssetFactory.EnemyPath + AssetName);
            m_Enemys.Add(AssetName, res);
        }
        return Object.Instantiate(m_Enemys[AssetName]) as GameObject;
    }
    ...
    public override GameObject LoadWeapon(string AssetName)
    {
        ...
        {
            Object res = m_RealFactory.LoadGameObjectFromResourcePath(ResourceAssetFactory.WeaponPath + AssetName);
            m_Weapons.Add(AssetName, res);
        }
        return Object.Instantiate(m_Weapons[AssetName]) as GameObject;
    }
